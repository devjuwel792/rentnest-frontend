...
const LeaveReviewModal = ({
  ...
  const propertyId = rental.property?.id ?? rental.propertyId;
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="mt-1 line-clamp-1 text-sm text-gray-500">
              {rental.property?.title ?? `Property ${propertyId ?? ""}`}
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        {status === "success" ? (
          <div className="mt-6 text-center">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Thanks for helping other tenants.
            </p>
            <button
              onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="How was your experience with this property?"
